...
Individual investors often compare technology stocks mainly based on recent price movements, but price performance alone does not show how much risk an investor is taking. This project will analyze major U.S. technology stocks such as Apple (AAPL), Microsoft (MSFT), and NVIDIA (NVDA) using historical market data to compare their returns, volatility, and downside risk.
